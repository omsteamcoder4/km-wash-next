      ...
      {/* <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="font-inter text-lg text-steel-gray max-w-3xl mx-auto">
              We provide comprehensive repair and maintenance services for all types of washing machines with genuine
              spare parts and expert technicians.
            </p>
          </div>
            ...
            {[
              {
                ...
                description:
                  "Expert repair service for front load washing machines including drum replacement, door seal repair, and control panel issues.",
                features: ["Drum Repair", "Door Seal Replacement", "Control Panel Fix", "Water Pump Service"],
                image:
              ...
              },
              {
                ...
                description:
                  "Complete repair solutions for top load washing machines including agitator repair, lid switch replacement, and motor issues.",
                features: ["Agitator Repair", "Lid Switch Fix", "Motor Service", "Timer Replacement"],
                image:
                  "https://images.unsplash.com/photo-1626806787461-102c1bfaaea1?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80",
                icon: "⚙️",
              },
              {
                title: "Fully Automatic Service",
                description:
                  "Specialized service for fully automatic washing machines with advanced diagnostic tools and genuine parts.",
                features: ["PCB Repair", "Sensor Replacement", "Program Fix", "Water Level Control"],
                image:
              ...
              },
              {
                ...
                description:
                  "Reliable repair service for semi-automatic washing machines including wash timer and spin motor issues.",
                features: ["Wash Timer Repair", "Spin Motor Fix", "Drain Pump Service", "Capacitor Replacement"],
                image:
              ...
              },
              {
                ...
                description:
                  "24/7 emergency repair service for urgent washing machine issues with same-day resolution guarantee.",
                features: ["24/7 Availability", "Same Day Service", "Emergency Response", "Quick Diagnosis"],
                image:
                  "https://images.unsplash.com/photo-1621905252507-b35492cc74b4?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80",
                icon: "🚨",
              },
              {
                title: "Annual Maintenance",
                description:
                  "Preventive maintenance service to keep your washing machine running efficiently and extend its lifespan.",
                features: ["Deep Cleaning", "Part Inspection", "Performance Check", "Preventive Care"],
                image:
                  "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80",
                icon: "🔍",
              },
            ].map((service, index) => (
              <div key={service.title} className="bg-white rounded-2xl shadow-lg overflow-hidden hover-lift">
                <div className="relative h-48 overflow-hidden">
                  ...
                  <div className="absolute top-4 left-4 w-12 h-12 bg-accent-yellow rounded-full flex items-center justify-center text-2xl shadow-lg">
                    {service.icon}
                  </div>
                </div>
                <div className="p-6">
                  <h3 className="font-poppins font-semibold text-xl text-primary-dark mb-3">{service.title}</h3>
                  <p className="font-inter text-steel-gray leading-relaxed mb-4">{service.description}</p>
                  <div className="space-y-2">
                    {service.features.map((feature, idx) => (
                      <div key={idx} className="flex items-center space-x-2">
                        <div className="w-2 h-2 bg-primary-blue rounded-full"></div>
                        <span className="font-inter text-sm text-steel-gray">{feature}</span>
                      </div>
                    ))}
                  </div>
                  <div className="mt-6 pt-4 border-t border-gray-200">
                    <a
                      ...
                      className="inline-flex items-center space-x-2 font-poppins font-medium text-primary-blue hover:text-primary-dark transition-colors duration-300"
                    >
